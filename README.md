...
executed via a **Jenkins** build.

## Disclaimer
As part of this showcase, the playbooks are intentionally **clean, commented, and safe** (no secrets, no real hosts).
...
inventory/           # Example inventories with dummy hosts
...
- Inventories are intentionally **minimal**; production repos would add group-specific vars, dynamic inventories, etc.
